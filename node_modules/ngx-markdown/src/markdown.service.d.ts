...
export declare class ExtendedRenderer extends Renderer {
    ɵNgxMarkdownRendererExtended: boolean;
}
export declare class MarkdownService {
    ...
    constructor(platform: Object, securityContext: SecurityContext, http: HttpClient, clipboardOptions: ClipboardOptions, options: MarkedOptions, sanitizer: DomSanitizer);
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<MarkdownService, [null, null, { optional: true; }, { optional: true; }, { optional: true; }, null]>;
